...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # CVE-2026-48710 (BadHost)/54283 (form-parser DoS)/48818 (StaticFiles UNC SSRF) — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.32",  # FastAPI UploadFile/Form for streaming uploads (NS-501); upstream v0.20 bump over the fork's 0.0.27
    ),
    ...
    "tool.computer_use": (
        "mcp==1.28.1",
        "starlette==1.3.1",  # CVE-2026-48710/54283 (form-parser DoS)/48818 (StaticFiles UNC SSRF) — keep in sync with pyproject [computer-use]
    ),

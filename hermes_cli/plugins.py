...
class PluginContext:
    ...
    @_serialized_replacement
    def register_context_engine(self, engine: "ContextEngine") -> Optional[PluginRegistration]:
    ...
    @_serialized_replacement
    def register_image_gen_provider(self, provider: "ImageGenProvider") -> Optional[PluginRegistration]:
    ...
    @_serialized_replacement
    def register_dashboard_auth_provider(self, provider: "DashboardAuthProvider") -> Optional[PluginRegistration]:
    ...
    @_serialized_replacement
    def register_video_gen_provider(self, provider: "VideoGenProvider") -> Optional[PluginRegistration]:
    ...
    @_serialized_replacement
    def register_web_search_provider(self, provider: "WebSearchProvider") -> Optional[PluginRegistration]:
    ...
    @_serialized_replacement
    def register_browser_provider(self, provider: "BrowserProvider") -> Optional[PluginRegistration]:
    ...
    @_serialized_replacement
    def register_tts_provider(self, provider: "TTSProvider") -> Optional[PluginRegistration]:
    ...
    @_serialized_replacement
    def register_transcription_provider(self, provider: "TranscriptionProvider") -> Optional[PluginRegistration]:
    ...
    def register_hook(self, hook_name: str, callback: Callable[..., Any]) -> PluginRegistration:
...
class PluginManager:
    ...
    def discover_and_load(self, force: bool = False) -> None:
        ...
        """
        # Enforce at the manager itself: wrappers are bypassable by callers
        # holding a direct manager reference.
        if os.environ.get("HERMES_WORKER_AUTHORITY", "").strip():
            logger.info(
                "Specialist worker authority active — plugin discovery skipped"
            )

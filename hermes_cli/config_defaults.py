...
DEFAULT_CONFIG = {
    ...
    "auth": {
        ...
        # FORK-LOCAL billing guard — consumed by
        # hermes_cli/runtime_provider.py::_auth_disable_paid_api_fallback_enabled.
    ...
    "delegation": {
        ...
        # FORK-LOCAL INVARIANT — guarded by
        # tests/security/test_merge_invariants.py; do not revert to True.
    ...
    "kanban": {
        ...
        # FORK-LOCAL INVARIANT (audit DISP-1/ARCH-2, 2026-06-19): default False so
        # config-loss / an upstream merge fails CLOSED (no unbounded multi-board worker
        # spawn before a global flock singleton lands). The deployed value is set
        # explicitly in config.yaml. Guarded by tests/security/test_merge_invariants.py
        # — do not flip back to True (upstream-vanilla default is True).
        "dispatch_in_gateway": False,
        # Automatically claim tasks in the first-class review column and spawn
        # the assigned profile with the bundled sdlc-review skill.
        # FORK-LOCAL INVARIANT (v0.20.1 merge, 2026-08-13): upstream defaults this
        # to True; the fork defaults False for the same fail-closed reason as
        # dispatch_in_gateway above — auto-claim + profile spawn is an autonomous
    ...
    "gateway": {
        ...
        # (see hermes_cli/active_sessions.py coerce_max_concurrent_agent_runs).

...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "anthropic": [
        # NOTE (fork): "claude-fable-5" is deliberately NOT offered here.
        # Post-cutover it is a paid-API SPEND-gated model, so it must never
        # appear in an interactive/curated picker; the literal id still
        # resolves metadata and validates for deliberate use. See commit
        # cce58e7c3 and tests/hermes_cli/test_anthropic_picker_curated.py.
        "claude-sonnet-5",
        "claude-opus-4-8",
        "claude-opus-4-7",
        "claude-opus-4-6",

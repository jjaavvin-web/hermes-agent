...
def _lock_card_id(lock: dict) -> str | None:
...
def _is_protected_reaper_branch(branch: str | None) -> bool:
    if not branch:
        return True
...
def _branch_has_open_pr(repo, branch: str) -> bool | None:
...
def _current_branch(repo) -> str | None:

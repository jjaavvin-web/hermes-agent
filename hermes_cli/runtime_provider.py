...
def resolve_runtime_provider(
    *,
    ...
    #
    # MERGE NOTE (v0.20): this gate deliberately runs BEFORE the
    # claude-cli-subprocess short-circuit below. An operator who writes
    # ``providers.claude-cli-subprocess.enabled: false`` must have that
    # honoured too — otherwise the short-circuit would return a live runtime
    # for a provider that was explicitly turned off. Fail-closed wins.

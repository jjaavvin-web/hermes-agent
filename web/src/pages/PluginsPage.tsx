...
// CopyButton is new in v0.20 and is used below; it ships from the same
// command-block subpath the fork already imported CommandBlock from.
import { CommandBlock, CopyButton } from "@nous-research/ui/ui/components/command-block";
// The remaining primitives stay on the fork's local shim, which 36 other
// dashboard files import. Migrating them to @nous-research/ui subpaths is a
// whole-dashboard change, not a per-file one.

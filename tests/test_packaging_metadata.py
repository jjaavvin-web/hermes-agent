...
# MERGE (v0.20): upstream relaxed this constant back to its own floor of
# (1, 0, 1) — the original CVE-2026-48710 fix version. The fork holds the
# HIGHER floor (1, 3, 1), which additionally covers CVE-2026-54283
# (form-parser DoS) and CVE-2026-48818 (StaticFiles UNC SSRF). The stricter
# floor wins; it is also exactly what upstream's own downgrade-guard table
# below asserts for starlette, so the two agree.

...
def pytest_collection_modifyitems(config, items):  # noqa: D401 - pytest hook
    ...
    # Fork-local patch (bc16b9f9a), restored across the v2026.7.1 merge:
    # docker tests build/run real images and routinely exceed the 30s
    # suite-default timeout, so bump every test under this directory to 180s.

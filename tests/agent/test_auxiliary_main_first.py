...
# FORK DIVERGENCE (2026-06-20 upstream merge): this fork keeps the FAIL-CLOSED
# auxiliary routing (text aux refuses paid/OpenRouter fallback for $0 cost
# control) rather than upstream's "use my main model for aux" main-first policy.
# These tests assert the main-first behavior we deliberately did NOT adopt.
pytestmark = pytest.mark.skip(
    reason="fork keeps fail-closed aux routing; upstream main-first policy not adopted"
)

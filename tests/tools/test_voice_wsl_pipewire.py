...
def _base(monkeypatch):
    ...
    # _wsl_powershell_tts_available() does a real shutil.which() probe of the
    # host for powershell.exe/ffmpeg. Pin it False so the "no forwarding"
    # test below deterministically hits the hard-block branch instead of
    # depending on whether this machine happens to have both on PATH.

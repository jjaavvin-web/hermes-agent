...
Both suites are kept across the v0.20 merge: the fork's function-style
cases (managed-queue submit URL building, webhook-url encoding) and
upstream's class-style cases. They cover the same module from different
angles and share no symbols.
"""
...
# ---------------------------------------------------------------------------
# Fork-side suite: managed FAL.ai SDK plumbing
# ---------------------------------------------------------------------------

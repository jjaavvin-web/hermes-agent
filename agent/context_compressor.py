    ...
    def compress(
        ...
        Args:
            ...
            preservation_context: Optional high-priority text from memory
                ...
                Fork channel (83f65db64) — carries the same provider payload
                as ``memory_context`` but renders it under the emphatic
                CRITICAL PRESERVATION CONTEXT heading.
        """
        ...
        if feasibility_skip:
            ...
            try:
                summary = self._generate_summary(
                    ...
                    memory_context=memory_context,
                    # Fork channel (83f65db64): CRITICAL PRESERVATION CONTEXT.
                    # Kept alongside upstream's memory_context so the fork's
                    # verbatim-preservation contract survives the v0.20 merge.
                    preservation_context=preservation_context,
                )

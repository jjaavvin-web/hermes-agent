...
class CodexAppServerSession:
    ...
    def _decide_exec_approval(self, params: dict) -> str:
        ...
        Fork note: "protocol-level routing only" does NOT exempt this path
        from the command-guard/hardline floor. The auto-approve short
        circuit below is deliberately guarded (KEYSTONE #1b) rather than
        returning "accept" unconditionally.
        """

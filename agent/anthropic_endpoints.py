...
def _is_third_party_anthropic_endpoint(base_url: str | None) -> bool:
    ...
    # Hostname boundary, not substring: "https://anthropic.com.evil.io" must NOT
    # be treated as the direct Anthropic API (it would receive the OAuth bearer
    # token). Fork security fix cdc3cdfbc0, re-applied after upstream's module
    # split; pinned by test_third_party_anthropic_endpoint_uses_hostname_boundary.
